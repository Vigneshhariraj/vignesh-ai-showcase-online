        ...
        <div className="text-center">
          ...
          >
            <div className="relative inline-block">
              <div className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center text-white text-4xl sm:text-5xl md:text-6xl font-bold shadow-2xl border-4 border-white mx-auto">
                VH
              </div>
